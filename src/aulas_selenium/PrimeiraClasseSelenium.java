...
public class PrimeiraClasseSelenium {
    ...
    @Test
    public void treinandoComFrames() throws InterruptedException, IOException {
...
//                "disable-infobars"
//        );
        chromeOptions.setHeadless(true); // Seta como headless
        chromeOptions.setAcceptInsecureCerts(true); // aceita certificados
        chromeOptions.addArguments("disable-popup-blocking");

        driver = new ChromeDriver(chromeOptions);
        driver.manage().window().maximize();

        driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS); // Timeout Carregameto da Pagina
        driver.manage().timeouts().pageLoadTimeout(15, TimeUnit.SECONDS);//Timeout carregamento da pagina
    ...
    public void screenShot(String nomeScrenShot) throws IOException {
        ...
        FileUtils.copyFile(arquivo, new File("output" + File.separator + nomeScrenShot + "_screenshot.jpg"));//Cria o arquivo .jpg
    }
